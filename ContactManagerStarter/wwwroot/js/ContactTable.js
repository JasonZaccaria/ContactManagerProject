...
$(function () {
    ...
    $(document).on("click", "#saveContactButton", function () {
        ...
        const addressInput = document.getElementById("newAddressStreet1");
        const emailErrorMsg = document.getElementById("unsubmittedEmail");
        const addressErrorMsg = document.getElementById("unsubmittedAddress");

        //below conditionals test for incomplete email and address input's

        if (emailInput.value !== "" && addressInput.value !== "") {
            emailInput.style.borderColor = "#dc3545";
            emailErrorMsg.classList.add("emailMsgOpen");
            addressInput.style.borderColor = "#dc3545";
            addressErrorMsg.classList.add("addressMsgOpen");
